        ...
        <div class="container">
           <div class="row">
            ...
            <div class="col-md-8">
                ...
                <br>
                Y si eres artista o celebridad, en esta plataforma digital, podras conectar con tus fans</p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-md-6 mx-auto">
        <div class="btn-wrapper profile border-bottom">
          ...
          <a target="_blank" href="#" class="btn btn-icon btn-neutral btn-round btn-lg btn-simple m-4" data-toggle="tooltip" data-original-title="Like us">
