          ...
          <div class="content-center text-left col-md-5 offset-md-3">
            <div class="card card-contact card-raised p-3" style="background-image: linear-gradient(to right top, #000000, #060003, #090009, #080110, #030316);">
              <div class="card-header text-center">
                ...
                <h4 class="card-title text-white display-4"><strong>Restablecer contraseña</strong></h4>
              </div>
                ...
                <form role="form" method="POST" action="{{ url('/password/reset') }}">
                  ...
                  <div class="card-footer text-center">
                    <div class="col-xs-12" style="padding-bottom: 15px;">
                      <button type="submit" class="btn btn-primary btn-round btn-lg btn-block">Restablecer contraseña</button>
                    </div>
                  </div>
                </form>
              </div>
